...
namespace MyTeamsCalender.Migrations
{
    /// <inheritdoc />
    public partial class _20240503112200 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamLeaderId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Channels_Teams_TeamsId",
                        column: x => x.TeamsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AbpUsers_RecieverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageReadReceipts_AbpUsers_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReadReceipts_ReceiverId",
                table: "MessageReadReceipts",
                column: "ReceiverId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AbpUsers_Channels_ChannelId",
                table: "AbpUsers",
                column: "ChannelId",
                principalTable: "Channels",
                principalColumn: "Id");
