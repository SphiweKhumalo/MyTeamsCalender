...
{
    public abstract class MyTeamsCalenderWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyTeamsCalenderWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyTeamsCalenderWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyTeamsCalenderDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyTeamsCalenderDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyTeamsCalenderDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyTeamsCalenderDbContext, Task<T>> func)
        {
            T result;
